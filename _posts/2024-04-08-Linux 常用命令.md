...
![Linux目录结构](LinuxFolder.png){: width="991" height="635" }
...
![软链接与硬链接](soft_hard_link.png){: width="880" height="500" }

![文件名、inode 与数据块的关系](link.png){: width="675" height="306" }
...
![硬链接与原文件共享 inode 和数据块](hard_link.png){: width="700" height="290" }
...
![软链接通过路径指向原文件](soft_link.png){: width="936" height="269" }
